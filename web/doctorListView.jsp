            ...
            <div align="right">
                ...
                <table border="1">
                    <tr>
                      ...
                      --%>  
                        <td><a href="searchServlet"><img src="find.jpg"></a></td>
  ...
  <%
                        ...
                        %>
                            <tr>
                                ...
                                %>
                                <td><a href="editHcareServlet?uid=<%=uid%>"><img src="Tick.png" ></a></td>
                                <td><a href="deleteHcareServlet?uid=<%=uid%>" onclick=" return deleteConfirm();"><img src="Cross.png"/></a></td>
                            </tr>
