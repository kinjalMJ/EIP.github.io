...
public final class Home_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        expireDate.setMonth(expireDate.getMonth()+6)\n");
      out.write("        jcount = eval(cookieVal(\"jaafarCounter\"))\n");
      out.write("        jcount++\n");
      out.write("        document.cookie = \"jaafarCounter=\"+jcount+\";expires=\" + expireDate.toGMTString()\n");
      out.write("\n");
      out.write("        function cookieVal(cookieName) {\n");
      out.write("        thisCookie = document.cookie.split(\"; \")\n");
      out.write("        for (i=0; i<thisCookie.length; i++){\n");
      out.write("        if (cookieName == thisCookie[i].split(\"=\")[0]){\n");
      out.write("        return thisCookie[i].split(\"=\")[1]\n");
      out.write("        }\n");
      out.write("        }\n");
      out.write("        return 0\n");
      out.write("        }\n");
      out.write("\n");
      out.write("        function page_counter(){\n");
      out.write("        for (i=0;i<(7-jcount.toString().length);i++)\n");
      out.write("        document.write('<span class=\"counter\">0</span>')\n");
      out.write("        for (y=0;y<(jcount.toString().length);y++)\n");
      out.write("        document.write('<span class=\"counter\">'+jcount.toString().charAt(y)+'</span>')\n");
      out.write("        }\n");
      out.write("        </SCRIPT>\n");
      out.write("\n");
      out.write("\n");
      ...
      out.write("\n");
      out.write("                                    <form method=\"get\" action=\"LoginServlet1\" id=\"form1\" name=\"formRe\">\n");
      ...
      out.write("                                            <input type=\"submit\" name=\"submit\" id=\"submit\" class=\"submitbtn\" value=\"Log in\"/>\n");
      out.write("                                        </fieldset>\n");
      out.write("                                        <fieldset id=\"Mylink\">\n");
      out.write("                                            <a href=\"forgetPassword.jsp\">Forgot your password?</a> \n");
      out.write("                                        </fieldset>\n");
      out.write("                                    </form>\n");
      out.write("                                </div> \n");
      out.write("                            </div>\n");
      ...
      out.write("                </style> \n");
      out.write("                \n");
      out.write("                <label id=\"counter\" name=\"visitors\" style=\"color: red;font-size: xx-large \">Visitors</label>\n");
      out.write("                <script>\n");
      out.write("                page_counter(jcount);\n");
      out.write("                    </script>\n");
      out.write("               \n");
      out.write("        </div>\n");
      out.write("\n");
