...
public class patientList extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try 
        {
                     ...
                     String query="select Patient_Id,First_Name,Last_Name,Gender,Blood_Group,Any_Abnormal_Symptoms from child_patient where flag=1 ORDER by User_Name";
                     ...
                     while(rs.next()) 
        {
                      ...
                      sb.append(rs.getString("Any_Abnormal_Symptoms"));
                      b1.add(sb);
                      ...
                      out.println(b1);
                      rd=request.getRequestDispatcher("/patientListView.jsp");
