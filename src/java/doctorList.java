...
Connection con=null;
        ...
        try 
        {
                    ...
                    String query="select healthcareProvider_Id,First_Name,Last_Name,Gender,Email_Id,City,Mobile_No from healthcare_provider_detail where flag=1 ORDER by User_Name";
                    //String query="select User_Id,First_Name,Type,Last_Name,Gender,Email_Id,City  from user_details where Type='doctor'";
                     ...
                     while(rs.next()) 
        {
                    ...
                    sb.append(rs.getString("healthcareProvider_Id")+":");
                    ...
                    sb.append(rs.getString("Mobile_No"));
                     ...
                     request.setAttribute("data", b1);
                      out.println(b1);
                      rd=request.getRequestDispatcher("/doctorListView.jsp");
