 ...
 * @author User
 */
public class healthcareProviderServelet extends HttpServlet {
     ...
     */
        ...
        try 
        {
            ...
            String uid=logicFunction.checkRequestNull(request, "uid");
                out.println(uid);
                  String query;        
                   ...
                   {
                       query="update healthcare_provider_detail set First_name='"+fname+"', Last_name='"+lname+"' , Gender='"+gender+"', Birth_Date='"+birthDate+"', Blood_Group='"+bloodGroup+"', Education='"+education+"', Experience='"+experience+"', Mobile_No='"+mobileNo+"', City='"+city+"',Email_Id='"+email+"', Description='"+description+"' where healthcareProvider_id="+uid;
                   ...
                   {
             query="insert into healthcare_provider_detail (First_Name,Last_Name,Gender,Birth_Date,Blood_Group,Education,Experience,Mobile_No,City,Email_Id,Description,User_Name,Password) values (?,?,?,?,?,?,?,?,?,?,?,?,?)";
            ...
            pstmt.executeUpdate();
                    ...
                    rd=request.getRequestDispatcher("doctorList");
